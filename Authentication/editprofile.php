...
if (isset($_POST['oldPassword'])) {
    ...
    if (empty($oldPassword)) {
        ...
        $stmt->execute();
        //Nó lấy kết quả của truy vấn vào một biến:
...
if (isset($_FILES['imageFile'])) {
    ...
    // tạo ra một tên hình ảnh duy nhất mới bằng cách sử dụng uniqid()và ghép nó với tên tệp gốc.
    $newimagename = uniqid() . '_' . $imageName;
    $destination = '../Public/img/' . $newimagename;
    // ể di chuyển hình ảnh đã tải lên từ vị trí tạm thời đến thư mục đích được chỉ định.
